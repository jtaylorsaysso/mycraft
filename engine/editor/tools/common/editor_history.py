...
class EditorHistory:
    ...
    def add_command(self, command: EditorCommand) -> None:
        """Add a command to history without executing it.
        
        Use this when the command has already been applied (e.g., during drag).
        ...
        self.redo_stack.clear()
        logger.debug(f"Added: {command.description}")
